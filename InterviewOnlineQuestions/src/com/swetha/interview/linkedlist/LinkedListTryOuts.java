...
public class LinkedListTryOuts {
	 ...
	 * @throws Exception
	 */
	public NodeSL findNthNodeInLinkedList(NodeSL linkedList, int n)
			throws Exception {
		NodeSL nthNode = null;
	 ...
	 * @throws Exception
	 */
	public NodeSL findNthElementFromEndOfLinkedList(NodeSL node, int n)
			throws Exception {
		NodeSL midNode = null;
		if (node == null || n == 0) {
			throw new Exception("Invalid input");
	 ...
	 * @param nodeSL
	 */
	public void recursivePrintNode(NodeSL nodeSL) {
		
		if(nodeSL != null){
			recursivePrintNode(nodeSL.next());
			System.out.print(nodeSL.getValue()+"-->");
		}
